# -*- coding: utf-8 -*-
"""train_resnet50_(1) (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16erLGrgmA548h5-6KIWW87OVn_f2HD0B
"""
...
def augmented_train(image, label):
    ...
    image = tf.image.random_brightness(image, 0.09)  # c-3
    image = tf.image.random_contrast(image, 0.5, 1.4)  # c-3
    # image = tf.image.random_crop(image, size=[60, 60, 3], seed=None, name=None) # c-4
    image = tf.image.central_crop(image, central_fraction=0.2)  # c-4
    return image, label
...
model.compile(
    optimizer=keras.optimizers.sgd(lr=0.008, momentum=0.9),
